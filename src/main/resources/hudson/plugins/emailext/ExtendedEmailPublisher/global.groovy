...
f.section(title: _("Extended E-mail Notification")) {
  ...
  f.advanced() {
    f.entry(help: "/plugin/email-ext/help/globalConfig/sendToUnknownUserPattern.html", title: _("Always send to unknown user matching (regex)")) {
       input(type: "text", class: "setting-input", value: descriptor.sendToUnknownUserPattern, name: "ext_mailer_send_to_unknown_user_pattern")
    }
